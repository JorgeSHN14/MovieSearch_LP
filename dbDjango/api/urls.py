...
from .views import LoginView, CustomUserList, CustomUserDetail, PeliculaList, PeliculaDetail, ReservaList, ReservaDetail, CarritoList, CarritoDetail, CompraList, CompraDetail
